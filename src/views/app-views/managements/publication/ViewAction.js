...
//     const scientistAPI = scientistService();
//     const [list, setList] = useState(null);
//     const [loading, setLoading] = useState(false);
//     const [selectedRows, setSelectedRows] = useState([]);
//     const [selectedRowKeys, setSelectedRowKeys] = useState([]);
//     const [scientistProfileVisible, setScientistProfileVisible] = useState(false);
...
//             }
//
//             res = await scientistAPI.showScientistListByCode(currentPage, current, sorter.order, sorter.field, value, codes);
//
//             if (res) {
//                 const existingData = JSON.parse(sessionStorage.getItem('scientistList')) || [];
//
...
//
//                 sessionStorage.setItem('scientistList', JSON.stringify(updatedData));
//
//                 setList(updatedData);
...
//             onOk: async () => {
//                 try {
//                     const res = await scientistAPI.record(id);
//                     if (res) {
//                         setScientistProfileVisible(true);
//                         setSelectedScientist(res.data.id);
...
//                     const res = await scientistAPI.recordMultiple(ids);
//                     if (res) {
//                         setSelectedRowKeys([]);
//                         history.push(`/app/managements/scientist/view-action`, {res});
//                         getList(selectedSorter, dataSearch);
//                         message.success('Copying successful');
//                     } else {
...
//         try {
//             await scientistAPI.deleteScientist(id);
...
//                     // 	setSelectedRowKeys([]);
//                     // 	setSelectedRows([]);
//                     const res = await scientistAPI.deleteMultiple(selectedRowKeys);
//
//                     if (res) {
//                         const existingData = JSON.parse(sessionStorage.getItem('scientistList')) || [];
//                         const newData = existingData.filter(item=> !selectedRowKeys.includes(item.id));
//                         sessionStorage.setItem('scientistList', JSON.stringify(newData));
//
//                         setList(newData);
//                         getList(selectedSorter, dataSearch);
//                         setSelectedRowKeys([]);
...
//
//     const viewDetail= (id) => {
//         history.push(`/app/managements/scientist/view-detail/${id}`);
//     };
//
//     //Edit
//     const editScientist = (id) => {
//         setScientistProfileVisible(true);
//         setSelectedScientist(id);
//     };
//
//     const closeEditScientist = async () => {
//         // const response = await scientistAPI.showScientistList(codes);
//         // setList(response);
//         setScientistProfileVisible(false);
...
//         <Menu>
//             <Menu.Item onClick={() => editScientist(elm.id)}>
...
//
//     const props = {
//         action: process.env.REACT_APP_API_URL + endPointAPI.ADMIN.Scientist.IMPORT,
...
//                 </div>
//             </Card>
//             <EditScientist id={ selectedScientist} visible={scientistProfileVisible} close={() => (closeEditScientist())}/>
//         </Card>
//     )
// }
//

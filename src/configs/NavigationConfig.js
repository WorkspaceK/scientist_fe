...
const managementNavTre = [{
  ...
  submenu: [
    ...
    },
    {
      ...
      title: 'sidenav.management.person',
      icon: HomeOutlined,
      breadcrumb: true,
      submenu: [
        {
          key: 'managements-person-list',
          path: `${APP_PREFIX_PATH}/managements/person/person-list`,
          title: 'sidenav.management.person.person-list',
          icon: '',
          breadcrumb: true,
          submenu: []
        },
    ...
    {
      key: 'managements-publication',
      path: `${APP_PREFIX_PATH}/managements/publication`,
      title: 'sidenav.management.publication',
      icon: IdcardOutlined,
      breadcrumb: true,
      submenu: [
        {
          key: 'managements-publication-list',
          path: `${APP_PREFIX_PATH}/managements/publication/publication-list`,
          title: 'sidenav.management.publication.publication-list',
          icon: '',
          breadcrumb: true,
          submenu: []
        },
